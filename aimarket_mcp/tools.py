...
TOOLS: List[Dict[str, Any]] = [
    {
        "name": "web_fetch",
        "description": "Fetch a web page by URL and return its main text content. SSRF-guarded; "
                       "output is sanitized and marked untrusted.",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "web_search",
        "description": "Search the web for current facts and return the top result snippets.",
        "inputSchema": {
            "type": "object",
    ...
    {
        "name": "metis_verify",
        "description": "Run Metis's cognition + verification envelope on an input; returns the "
                       "answer plus a machine-readable verify_score/verified flag to gate on.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "input": {"type": "string", "description": "the question/task to verify-answer"},
                "route": {"type": "string", "enum": ["fast", "thinking", "council", "agent"],
                          "description": "cognition depth (default council)"},
            },
            "required": ["input"],
        },
